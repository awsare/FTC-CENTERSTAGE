...
@Autonomous(name = "Red WING LIFTED \uD83E\uDD91 Wall Park", group = "red")
public class RedWingWallParkLifted extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action act05 = drive.actionBuilder(new Pose2d(42, -29, Math.toRadians(0)))
