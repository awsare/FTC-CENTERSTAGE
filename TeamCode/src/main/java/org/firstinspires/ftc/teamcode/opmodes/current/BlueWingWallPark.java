...
public class BlueWingWallPark extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action act03 = drive.actionBuilder(new Pose2d(42, 42.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(47.5, 42.5))
                .build();

        Action act04 = drive.actionBuilder(new Pose2d(47.5, 42.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(42, 42.5))
                .build();

        Action act05 = drive.actionBuilder(new Pose2d(42, 36, Math.toRadians(0)))
