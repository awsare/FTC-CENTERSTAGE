...
public class RedWing extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action act11 = drive.actionBuilder(drive.pose)
                .strafeTo(new Vector2d(-40, -38.5))
                .build();

        Action act12 = drive.actionBuilder(new Pose2d(-40, -38.5, Math.toRadians(90)))
        ...
        Action act21 = drive.actionBuilder(drive.pose)
                .strafeToLinearHeading(new Vector2d(-36.5, -37), Math.toRadians(10))
                .build();

        Action act22 = drive.actionBuilder(new Pose2d(-36.5, -37, Math.toRadians(10)))
        ...
        Action act23 = drive.actionBuilder(new Pose2d(42, -41.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(47.5, -41.5))
                .build();

        Action act24 = drive.actionBuilder(new Pose2d(47.5, -41.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(42, -41.5))
                .build();

        Action act251 = drive.actionBuilder(new Pose2d(42, -41.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(47, -11))
                .strafeTo(new Vector2d(58, -11))
                .build();

        Action act252 = drive.actionBuilder(new Pose2d(42, -41.5, Math.toRadians(0)))
                .strafeTo(new Vector2d(47, -61.5))
                .strafeTo(new Vector2d(58, -61.5))
                .build();
